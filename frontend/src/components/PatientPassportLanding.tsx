      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            Your Health, Your Control: Patient Passport
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Keep all your sensitive health data protected with state-of-the-art encryption and privacy controls.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Gain a deeper understanding of your health with clear visualizations and actionable insights from your data.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Manage prescriptions, set reminders, and track adherence with medication schedules made effortless.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Share your passport records with healthcare providers for better communication and coordinated care.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-green-600 py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-green-50 mb-8">
            Join Patient Passport today and experience a new era of medical record management.
          </p>
          <button className="bg-white hover:bg-gray-100 text-green-600 font-semibold px-8 py-3 rounded-md transition-colors">
            Get Started Now
          </button>
        </div>
      </section>
